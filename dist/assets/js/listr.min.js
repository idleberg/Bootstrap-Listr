...
var hidden=$("tr.hidden");$(document).bind("keydown",function(e){e.altKey&&$(hidden).addClass("reveal").removeClass("hidden")}).bind("keyup",function(){$(hidden).removeClass("reveal").addClass("hidden")}),$(document).bind("keyup",function(e){70===e.which&&$("#search").focus(),viewer.hasClass("in")&&(32===e.which&&(e.preventDefault(),0==player.paused?player.pause():player.play()),37===e.which&&(player.currentTime=0),38===e.which&&(player.volume+=.1),40===e.which&&(player.volume-=.1))});
