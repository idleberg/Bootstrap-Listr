...
A simple PHP script to display folders and files on a server in a well formed list, based on the style-sheets provided by [Bootstrap 3](http://getbootstrap.com).
